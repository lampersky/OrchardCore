...
internal static class IContentDefinitionManagerExtensions
{
    ...
    public static async Task<TSettings> GetFieldSettingsAsync<TField, TSettings>(this IContentDefinitionManager contentDefinitionManager, string typeName, string fieldName) where TSettings : new()
    {
